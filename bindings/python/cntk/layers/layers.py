...
def Dense(shape, activation=default_override_or(identity), init=default_override_or(glorot_uniform()),
          ...
          name=''):
    '''
    Dense(shape, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), input_rank=None, map_rank=None, bias=default_override_or(True), init_bias=default_override_or(0), name='')
...
def Convolution(filter_shape,     # shape of receptive field, e.g. (3,3)
    ...
    '''
    Convolution(filter_shape, num_filters=None, sequential=False, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, sharing=True, bias=default_override_or(True), init_bias=default_override_or(0), reduction_rank=1, transpose_weight=False, max_temp_mem_size_in_samples=0, op_name='Convolution', name='')
...
def Convolution1D(filter_shape,     # shape of receptive field, e.g. (3)
                  ...
                  name=''):
    '''
    Convolution1D(filter_shape, num_filters=None, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, bias=default_override_or(True), init_bias=default_override_or(0), reduction_rank=1, name='')
...
def Convolution2D(filter_shape,     # shape of receptive field, e.g. (3,3). Must be a 2-element tuple.
                  ...
                  name=''):
    '''
    Convolution2D(filter_shape, num_filters=None, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, bias=default_override_or(True), init_bias=default_override_or(0), reduction_rank=1, name='')
...
def Convolution3D(filter_shape,     # shape of receptive field, e.g. (3,3,3). Must be a 3-element tuple.
                  ...
                  name=''):
    '''
    Convolution3D(filter_shape, num_filters=None, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, bias=default_override_or(True), init_bias=default_override_or(0), reduction_rank=1, name='')
...
def ConvolutionTranspose(filter_shape,        # shape of receptive field, e.g. (3,3)
    ...
    '''
    ConvolutionTranspose(filter_shape, num_filters, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, sharing=True, bias=default_override_or(True), init_bias=default_override_or(0), output_shape=None, reduction_rank=1, max_temp_mem_size_in_samples=0, name='')
...
def ConvolutionTranspose1D(filter_shape,        # a scalar, e.g., 3 
                           ...
                           name=''):
    '''
    ConvolutionTranspose1D(filter_shape, num_filters, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, bias=default_override_or(True), init_bias=default_override_or(0), output_shape=None, name='')
...
def ConvolutionTranspose2D(filter_shape,        # a 2D tuple, e.g., (3,3) 
                           ...
                           name=''):
    '''
    ConvolutionTranspose2D(filter_shape, num_filters, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, bias=default_override_or(True), init_bias=default_override_or(0), output_shape=None, name='')
...
def ConvolutionTranspose3D(filter_shape,        # a 3D tuple, e.g., (3,3,3) 
                           ...
                           name=''):
    '''
    ConvolutionTranspose3D(filter_shape, num_filters, activation=default_override_or(identity), init=default_override_or(glorot_uniform()), pad=default_override_or(False), strides=1, bias=default_override_or(True), init_bias=default_override_or(0), output_shape=None, name='')
...
def MaxPooling(filter_shape,  # shape of receptive field, e.g. (3,3)
               ...
               name=''):
    '''
    MaxPooling(filter_shape, strides=1, pad=default_override_or(False), name='')
...
def AveragePooling(filter_shape,  # shape of receptive field, e.g. (3,3)
                   ...
                   name=''):
    '''
    AveragePooling(filter_shape, strides=1, pad=default_override_or(False), name='')
